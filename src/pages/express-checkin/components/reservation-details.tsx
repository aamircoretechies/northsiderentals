    ...
    <div className="flex flex-col relative w-full items-stretch">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col">
          ...
          <span className="text-black font-extrabold text-[14px] sm:text-[15px] leading-tight mb-1">{pickupDate}</span>
          <span className="text-[#8692a6] text-[13px] sm:text-[14px] leading-tight">{pickupLocation}</span>
        </div>
        <div className="flex flex-col border-l border-gray-100 pl-4">
          <span className="text-[#8692a6] text-[12px] mb-1">Return:</span>
          <span className="text-black font-extrabold text-[14px] sm:text-[15px] leading-tight mb-1">{returnDate}</span>
          <span className="text-[#8692a6] text-[13px] sm:text-[14px] leading-tight">{returnLocation}</span>
        </div>
      </div>
    </div>
  );
