...
import { CarsCheckoutPaymentPage } from '@/pages/cars/checkout/payment';
    ...
    <Routes>
      <Route element={<RequireAuth />}>
        <Route element={<Demo9Layout />}>
          ...
          />
          <Route
            path="/cars/search-results-grid"
            element={<CarsSearchResultsGridPage />}
          />
          <Route
            path="/cars/checkout/options"
            element={<CarsCheckoutOptionsPage />}
          />
          <Route
            path="/cars/checkout/details"
            element={<CarsCheckoutDetailsPage />}
          />
          <Route
            path="/cars/checkout/payment"
            element={<CarsCheckoutPaymentPage />}
          />
          <Route
            path="/cars/checkout/success"
            element={<CarsCheckoutSuccessPage />}
          />
